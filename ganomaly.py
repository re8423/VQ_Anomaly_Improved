...
#Script to run Ganomaly model from anomalib
...
#     torch.save(model.state_dict(), '/home2/mvdk66/Anomaly_main/anomalib/notebooks/Prev/results/ganomaly/UCSD/run/weights/ga_cp_2')
    print('model saved!')
